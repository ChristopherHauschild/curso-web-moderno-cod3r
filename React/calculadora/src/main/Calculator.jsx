...
export default class Calculator extends Component {
    ...
    state = { ...initialState } // Criado um clone do objeto e atribuido ao state
    ...
    setOperation(operation) {
        ...
        if (this.state.current === 0) { // Mexer em current para pegar segundo valor do vetor
            ...
            const equals = operation === '=' // Quando usuário clicar em =
    ...
    addDigit(n) {
        // Impede que usuário digite um '.' caso o display já possua '.'
